...
%----------------------------------------------------------------------------------------
    ...
    \section{Ejercicio 2}
		...
		\subsection{?`Cuál es el plan Óptimo?}
			...
			\begin{itemize}
				\item \textbf{16200} u.m. en el momento de la compra.
				\item 24360 u.m. más intereses en el segundo plazo, es decir, \textbf{26250} u.m.
				\item 13440 u.m. más intereses en el ultimo plazo, es decir, \textbf{14112} u.m.
			\end{itemize}
		...
		\subsection{Determinar la solución Óptima del problema formulado en (c) utilizando las condiciones de holgura complementaria.}
			...
			\paragraph{}
			Aplicando el teorema de holgura complementaria llegamos a la siguiente solución: \(w_{1}^{*} = 1.82 \), \(w_{2}^{*} = 2.38 \), \(w_{4}^{*} = -1.05 \), \(w_{5}^{*} = -1 \), \(w_{6}^{*} = 3.48 \)lo cual resulta en \(z^{*} = 56388\)
